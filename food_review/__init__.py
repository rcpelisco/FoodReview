...
app.register_blueprint(writers, url_prefix='/writer')
app.register_blueprint(writers_users, url_prefix='/writer')
app.register_blueprint(writers_recipes, url_prefix='/writer/recipes')
